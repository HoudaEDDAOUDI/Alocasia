...
<main class="my_profil">
    <section class="profile-section">
        ...
        <?php
            ...
            // Récupérer les informations de l'utilisateur et le chemin de la photo
            $req = 'SELECT utilisateurs.*, parcelles.*, jardins.*, utilisateurs.utilisateurs_photo 
                    FROM parcelles
                    ...
                    WHERE utilisateurs.utilisateurs_id = "'.$_SESSION['utilisateurs_id'].'" 
                    AND parcelles.parcelles_disponibilite = "réservée"';
            $resultat = $mabd->query($req);
            $row = $resultat->fetch(PDO::FETCH_ASSOC); // Récupérer une seule ligne de résultat
        ?>
        <div class="profile-info2">
            <div class="profile-info">
                <div class="profile-picture">
                    <?php 
                            echo '<img id="profile-picture" src="/images/uploads/'.$_SESSION['utilisateurs_photo'].'" alt="Photo de profil">';
                        
                    ?>
                    <a id="modif_pro" href="modif/profil_modif.php?num=<?php echo $_SESSION['utilisateurs_id']; ?>">
                        <p class="probleme">.</p>
                ...
                <div class="profile-picture2"> 
                    <p><?php echo htmlspecialchars($_SESSION['utilisateurs_nom']) . ' ' . htmlspecialchars($_SESSION['utilisateurs_prenom']); ?></p>
